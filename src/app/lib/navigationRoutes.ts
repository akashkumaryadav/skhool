...
import { SiteRoute } from '../components/commandPallete/CommandPallete';
  ...
  export const mainNavItems: NavItemType[] = [
    // Teacher Routes
    { name: "Dashboard", href: "/teacher", icon: LayoutDashboard, current: true, role: "teacher" },
    { name: "Students", href: "/teacher/students", icon: Users, role: "teacher" },
    { name: "Attendance", href: "/teacher/attendance", icon: CalendarCheck2, role: "teacher" },
    { name: "Grades/Performance", href: "/teacher/grades", icon: Users, role: "teacher" }, // Assuming a different icon was intended
    { name: "Learning Resources", href: "/teacher/resources", icon: BookCopy, role: "teacher" },
  
    // Student Routes
    { name: "Student Dashboard", href: "/student/dashboard", icon: LayoutDashboard, role: "student" },
    { name: "My Courses", href: "/student/courses", icon: BookA, role: "student" },
    { name: "My Grades", href: "/student/grades", icon: Users, role: "student" },
    { name: "My Attendance", href: "/student/attendance", icon: CalendarCheck2, role: "student" },
    { name: "View Resources", href: "/student/resources", icon: BookA, role: "student" },
    { name: "Student Settings", href: "/student/settings", icon: Cog, role: "student" },
  ...
  export const accountNavItems: NavItemType[] = [
    ...
    { name: "Admin AI Helper", href: "/admin/ai-helper", icon: Bot, role: "admin" },
    { name: "Admin Settings", href: "/admin/settings", icon: Cog, role: "admin" },
  ];
