...
const AIHelperPage: React.FC = () => {
  ...
  const predefinedPrompts: {
    ...
    {
      title: "Lesson Plan Spark",
      prompt:
        "Suggest some creative starting points or engaging activities for a new lesson plan. I'm open to ideas for any subject suitable for middle school.",
      icon: LightBulbIcon,
    },
    {
      title: "Quiz Question Ideas",
      prompt:
        "Help me generate a few sample quiz questions (e.g., 2 multiple choice, 1 true/false) for a generic middle school subject like Science or History.",
      icon: LightBulbIcon,
    },
    {
      title: "Explain a Concept Simply",
      prompt:
        "Explain a common educational concept, for example 'democracy' or 'the water cycle', in very simple terms suitable for a 10-12 year old.",
      icon: LightBulbIcon,
    },
    {
      title: "Positive Feedback Phrases",
      prompt:
        "Provide a list of 5-7 encouraging and constructive feedback phrases I can use for student assignments.",
      icon: LightBulbIcon,
    },
    {
      title: "Quick Classroom Activity",
      prompt:
        "Suggest a quick (5-10 minute) and engaging classroom activity that requires minimal preparation and can be used as a warm-up or energizer.",
      icon: LightBulbIcon,
    },
  ];
