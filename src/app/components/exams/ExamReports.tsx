...
export const ExamReports: React.FC<ExamReportsProps> = ({ selectedExamId }) => {
  ...
  const { data: reportData, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await axiosInstance.get(`/api//exams/reports?${params}`);
  ...
  const downloadReport = async (format: "pdf" | "excel") => {
    try {
      ...
      const response = await axiosInstance.get(
        `/api//exams/reports/download?${params}`,
        {
          responseType: "blob",
        }
      );
      ...
      link.setAttribute(
        "download",
        `exam_report_${moment().format("YYYY-MM-DD")}.${
          format === "pdf" ? "pdf" : "xlsx"
        }`
      );
  ...
  const performanceData =
    reportData?.results
      .map((result) => {
        const student = reportData.studentDetails.find(
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  {reportData.exam.subject} • {reportData.exam.className}{" "}
                  {reportData.exam.section} •
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {reportData.analytics.studentsAppeared}
                </p>
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {reportData.analytics.averageMarks.toFixed(1)}
                </p>
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {reportData.analytics.passPercentage.toFixed(1)}%
                </p>
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {reportData.analytics.highestMarks}
                </p>
