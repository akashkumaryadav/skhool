...
export function GenericDataTable<T extends { id: string | number }>({
  ...
  const filteredData = useMemo(() => {
    let filtered = data;
    const combinedFilters = { ...activeFilters, ...aiFilters };
    ...
    if (searchTerm && Object.keys(combinedFilters).length === 0) {
    ...
    return filtered;
  }, [data, searchTerm, activeFilters, aiFilters]);
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm w-full">
        ...
        <div className="mb-4 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {Object.entries({ ...activeFilters, ...aiFilters }).map(
              ([key, value]) =>
                value && (
                  <div
                    key={key}
                  ...
                  >
                    {aiFilters[key] && <span title="Generated by AI">✨</span>}
                    <span>
                      {
                    ...
                    <X
                      ...
                      onClick={() => {
                        if (activeFilters[key]) removeFilter(key);
                        if (aiFilters[key]) {
                          setSearchTerm("");
                          onSearchQueryChange("");
                        }
